  ...
  return (
    <>
      <header className="top_panel top_panel_custom top_panel_custom_396 with_bg_image petermason_inline_970499150 scheme_default">
        <div className="vc_row wpb_row vc_row-fluid vc_custom_1482933118679 vc_row-has-fill vc_row-o-equal-height vc_row-o-content-middle vc_row-flex sc_layouts_row sc_layouts_row_type_narrow sc_layouts_hide_on_mobile">
          <div className="wpb_column vc_column_container vc_col-sm-6 sc_layouts_column sc_layouts_column_align_left sc_layouts_column_icons_position_left">
            <div className="vc_column-inner">
              <div className="wpb_wrapper">
                ...
                <div className="sc_layouts_item">
                  <div
                    id="sc_layouts_iconed_text_506552033"
                    className="sc_layouts_iconed_text"
                  >
                    <a
          ...
          <div className="wpb_column vc_column_container vc_col-sm-6 sc_layouts_column sc_layouts_column_align_right sc_layouts_column_icons_position_left">
            <div className="vc_column-inner">
              <div className="wpb_wrapper">
                <div className="sc_layouts_item">
                  <div
                    id="sc_layouts_cart_1848090951"
        ...
        <div
          className={`vc_row wpb_row vc_row-fluid sc_layouts_row sc_layouts_row_delimiter sc_layouts_row_fixed sc_layouts_row_type_compact  vc_custom_1482224342343 vc_row-has-fill ${
                ...
                >
                  <div className="sc_content_container">
                    <div className="vc_row wpb_row vc_inner vc_row-fluid vc_row-o-equal-height vc_row-o-content-middle vc_row-flex">
                      <div className="wpb_column vc_column_container vc_col-sm-3 sc_layouts_column sc_layouts_column_align_center sc_layouts_column_icons_position_left">
                        <div className="vc_column-inner">
                          <div className="wpb_wrapper">
                            <div className="sc_layouts_item">
                              <a
                                id="sc_layouts_logo_804622935"
                      ...
                      <div className="menu_mobile_right wpb_column vc_column_container vc_col-sm-9 sc_layouts_column_icons_position_left">
                        <div className="vc_column-inner">
                          <div className="wpb_wrapper">
                            <div className="sc_layouts_item">
                              <nav
